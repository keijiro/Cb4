        ...
        void Start()
        {
            ...
            for (var i = 0; i < _columns; i++)
            {
                ...
                for (var j = 0; j < _rows; j++)
                {
                    ...
                    var pos = origin + new Vector3(x, 0, y);
                    ...
                    dancer.stepFrequency *= (Random.Range(0, 1) * 0.5f + Random.Range(0.8f, 1.2f));
                    ...
                    dancer.noiseFrequency *= (Random.Range(0, 1) * 0.5f + Random.Range(0.8f, 1.2f));
